                ...
                Button(
                    ...
                    onClick = {
                        if (updatedCityName.isNotBlank() && updatedProvinceName.isNotBlank()) {
                            //checking if the selectedCity is not null
                            //if it is not null, then putting the value of selectedCity in it
                            selectedCity?.let {
        ...
        LazyColumn(Modifier.fillMaxSize()) {
            itemsIndexed(cities) { index, city ->
                CityRow(city = city,
                    onCityClick = {
                        selectedCity = it
                        updatedCityName = it.name
                        updatedProvinceName = it.province
                    }
                )
